          ...
          <>
            ...
            >
              <div className="max-w-4xl mx-auto">
                ...
                <button 
                  onClick={() => { onSelectTopic(selectedTopic.subject, selectedTopic.topic, 'GUIDED_LESSON'); setSelectedTopic(null); }}
                  className="group flex flex-col items-center gap-4 p-6 rounded-[30px] bg-indigo-600 text-white font-black uppercase italic tracking-tighter hover:scale-105 transition-all shadow-xl shadow-indigo-200"
                  >
                  <div className="w-12 h-12 bg-white/20 rounded-2xl flex items-center justify-center group-hover:bg-white group-hover:text-indigo-600 transition-all font-sans">
                    <BookOpen className="w-5 h-5" />
                  </div>
                    <span className="text-xs">Aula Guiada IA</span>
                </button>
                <button 
                  onClick={() => { onSelectTopic(selectedTopic.subject, selectedTopic.topic, 'LESSON'); setSelectedTopic(null); }}
                  className="group flex flex-col items-center gap-4 p-6 rounded-[30px] bg-blue-600 text-white font-black uppercase italic tracking-tighter hover:scale-105 transition-all shadow-xl shadow-blue-200"
                  >
                  <div className="w-12 h-12 bg-white/20 rounded-2xl flex items-center justify-center group-hover:bg-white group-hover:text-blue-600 transition-all font-sans">
                    ...
                    <span className="text-xs">Papo com Peixe</span>
                </button>
                <button 
                  onClick={() => { onSelectTopic(selectedTopic.subject, selectedTopic.topic, 'QUIZ'); setSelectedTopic(null); }}
                  className="group flex flex-col items-center gap-4 p-6 rounded-[30px] bg-[#0A0F1E] text-white font-black uppercase italic tracking-tighter hover:scale-105 transition-all shadow-xl shadow-gray-200"
                  >
                  <div className="w-12 h-12 bg-white/10 rounded-2xl flex items-center justify-center group-hover:bg-orange-500 transition-all font-sans">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2-2z" /></svg>
                  </div>
                    <span className="text-xs">Batalha Quiz</span>
                </button>
                <button 
                  onClick={() => { onSelectTopic(selectedTopic.subject, selectedTopic.topic, 'FLASHCARDS'); setSelectedTopic(null); }}
                  className="group flex flex-col items-center gap-4 p-6 rounded-[30px] bg-yellow-400 text-white font-black uppercase italic tracking-tighter hover:scale-105 transition-all shadow-xl shadow-yellow-100"
                  >
                  <div className="w-12 h-12 bg-white/20 rounded-2xl flex items-center justify-center group-hover:bg-white group-hover:text-yellow-600 transition-all font-sans">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M8 7v8a2 2 0 002 2h6M8 7V5a2 2 0 012-2h4.586a1 1 0 01.707.293l4.414 4.414a1 1 0 01.293.707V15a2 2 0 01-2 2h-2M8 7H6a2 2 0 00-2 2v10a2 2 0 002 2h12a2 2 0 002-2v-2" /></svg>
                  </div>
                    <span className="text-xs">Ver Flashcards</span>
                </button>
              </div>
